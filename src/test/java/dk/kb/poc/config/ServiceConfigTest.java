...
class ServiceConfigTest {
     ...
     */
    // TODO: Enable this in a better form
    void sampleConfigTest() throws IOException {
        ...
        Path sampleEnvironmentSetup = Path.of(projectRoot, "conf/poc-backend-environment.yaml");
        assertTrue(Files.exists(sampleEnvironmentSetup),
                   "The sample setup is expected to be present at '" + sampleEnvironmentSetup + "'");

        ServiceConfig.initialize(projectRoot + File.separator + "conf" + File.separator + "poc-backend*.yaml");
